...
::: callout-warning
This tutorial assumes you've completed [Getting started](01-getting-started.qmd). If not, start there first!!!
:::
...
![](../assets/Vids/ShowStatus.gif){fig-align="center" width="960"}
