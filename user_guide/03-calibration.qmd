...
::: callout-warning
This tutorial assumes you've completed [Getting started](02-getting-started.qmd). If not, start there first!!!
:::
...
![](../assets/videos/ShowStatus.gif){fig-align="center" width="960px"}
...
::: {.Advanced title="Customize calibration"}
You can customize several aspects of the calibration procedure to match your experimental needs, let's explore some of the key parameters:
