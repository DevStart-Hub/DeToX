...
| Name   | Type                             | Description                                                                 | Default     |
+========+==================================+=============================================================================+=============+
| N      | [float](`float`) or [int](`int`) | Buffer size specification. Interpretation depends on `units` parameter:     | `0.5`       |
|        |                                  |                                                                             |             |
...
+--------+----------------------------------+-----------------------------------------------------------------------------+-------------+
| units  | [str](`str`)                     | Unit for buffer size specification: 'seconds' or 'samples'.                 | `'seconds'` |
|        |                                  |                                                                             |             |
