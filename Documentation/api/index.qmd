...
| [ETracker.calibrate](ETracker.calibrate.qmd#DeToX.ETracker.calibrate) | Run the infant-friendly calibration procedure. |
...
| [ETSettings.FontSizeMultipliers](ETSettings.FontSizeMultipliers.qmd#DeToX.ETSettings.FontSizeMultipliers) | Font size multipliers for different text types. |