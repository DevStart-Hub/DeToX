...
| [ETracker.set_eyetracking_settings](ETracker.set_eyetracking_settings.qmd#DeToX.ETracker.set_eyetracking_settings) | Configure and apply Tobii eye tracker settings. |
...
| [psychopy_to_pixels](psychopy_to_pixels.qmd#DeToX.psychopy_to_pixels) | Convert PsychoPy coordinates to pixel coordinates for image drawing. |
...
| [get_psychopy_pos_from_user_position](get_psychopy_pos_from_user_position.qmd#DeToX.get_psychopy_pos_from_user_position) | Convert User Position Guide coordinates to PsychoPy coordinates. |

## Utilities

A functions for presenting stimuli
